...
/**
 * Minimal inline icon set drawn in the Lucide style (24×24, stroke, round caps).
 * No external icon dependency — keeps the bundle lean and CSP-clean.
 *
...
const ICONS: Record<string, string> = {
  ...
  send:
    '<path d="M14.54 21.69a.5.5 0 0 0 .93-.02l6.5-19a.5.5 0 0 0-.63-.64l-19 6.5a.5.5 0 0 0-.02.94l7.93 3.18a2 2 0 0 1 1.11 1.11z"/><path d="m21.85 2.15-10.94 10.94"/>',
  linkedin:
  ...
  quote:
    '<path d="M3 21c3 0 7-1 7-8V5c0-1.25-.76-2.02-2-2H4c-1.25 0-2 .75-2 1.97V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .01-1 1.03V20c0 1 0 1 1 1z"/><path d="M15 21c3 0 7-1 7-8V5c0-1.25-.76-2.02-2-2h-4c-1.25 0-2 .75-2 1.97V11c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1z"/>',
  lock:
    '<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',
  headset:
    '<path d="M3 11a9 9 0 0 1 18 0"/><path d="M21 16v2a4 4 0 0 1-4 4h-5"/><rect width="4" height="8" x="17" y="11" rx="1.5"/><rect width="4" height="8" x="3" y="11" rx="1.5"/>',
  eye:
...
export class IconComponent {
  ...
  private readonly _name = signal('sparkles');
  ...
  readonly svg = computed<SafeHtml>(() =>
    this.sanitizer.bypassSecurityTrustHtml(ICONS[this._name()] ?? ICONS['sparkles'])
  );
}
