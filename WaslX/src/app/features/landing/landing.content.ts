...
const en: LandingContent = {
  ...
  pricingPage: {
    ...
    plans: [
      { id: 'starter', icon: 'zap', name: 'Starter', tagline: 'For small teams handling WhatsApp support manually.', priceMonthly: 30, priceYearly: 25, priceCustom: null, cta: 'Get started', popular: false, features: ['Up to 1,000 conversations / month', 'Up to 2 agents', 'AI reply suggestions (1–3 per message)', 'Manual conversation assignment', 'Shared database', 'Email support'] },
      { id: 'growth', icon: 'sparkles', name: 'Growth', tagline: 'The full AI pipeline for scaling support teams.', priceMonthly: 138, priceYearly: 115, priceCustom: null, cta: 'Get started', popular: true, features: ['Up to 3,000 conversations / month', 'Up to 5 agents', 'Full AI pipeline: RAG memory, routing & classification', 'Conversation summaries on handoff', 'Auto-escalation for urgent / VIP / angry conversations', 'Off-hours acknowledgment & FAQ auto-resolve', 'Email + live chat support'] },
      { id: 'business', icon: 'trending-up', name: 'Business', tagline: 'Everything in Growth, tuned for larger teams.', priceMonthly: 340, priceYearly: 282, priceCustom: null, cta: 'Get started', popular: false, features: ['Up to 8,000 conversations / month', 'Up to 15 agents', 'Everything in Growth', 'Agent scoring & smart selection', 'Priority support'] },
      { id: 'enterprise', icon: 'shield', name: 'Enterprise', tagline: 'Custom scale, isolation and support.', priceMonthly: null, priceYearly: null, priceCustom: 'Custom', cta: 'Contact sales', popular: false, features: ['Unlimited conversations & agents', 'Dedicated database per tenant', 'Dedicated account manager', 'Custom integrations & SLA'] },
    ],
    comparisonTitle: 'Compare every plan',
    comparisonPlans: ['Starter', 'Growth', 'Business', 'Enterprise'],
    comparison: [
      { feature: 'Conversations / month', cells: ['1,000', '3,000', '8,000', 'Unlimited'] },
      { feature: 'Agents', cells: ['Up to 2', 'Up to 5', 'Up to 15', 'Unlimited'] },
      { feature: 'AI reply suggestions', cells: ['yes', 'yes', 'yes', 'yes'] },
      { feature: 'AI routing + RAG memory (full pipeline)', cells: ['no', 'yes', 'yes', 'yes + custom tuning'] },
      { feature: 'Conversation summaries', cells: ['no', 'yes', 'yes', 'yes'] },
      { feature: 'Auto-escalation (VIP / urgent / angry)', cells: ['no', 'yes', 'yes', 'yes'] },
      { feature: 'Agent scoring & smart selection', cells: ['no', 'no', 'yes', 'yes'] },
      { feature: 'Database', cells: ['Shared', 'Shared', 'Shared', 'Dedicated'] },
      { feature: 'Support', cells: ['Email', 'Email + Chat', 'Priority', 'Dedicated manager'] },
    ],
...
const ar: LandingContent = {
  ...
  pricingPage: {
    ...
    plans: [
      { id: 'starter', icon: 'zap', name: 'Starter', tagline: 'للفرق الصغيرة اللي بتتعامل مع دعم واتساب يدويًا.', priceMonthly: 30, priceYearly: 25, priceCustom: null, cta: 'ابدأ الآن', popular: false, features: ['حتى ١٬٠٠٠ محادثة شهريًا', 'حتى وكيلين', 'اقتراحات رد بالـ AI (١-٣ اقتراحات لكل رسالة)', 'تعيين محادثات يدوي', 'قاعدة بيانات مشتركة', 'دعم عبر الإيميل'] },
      { id: 'growth', icon: 'sparkles', name: 'Growth', tagline: 'خط الـ AI الكامل للفرق اللي بتتوسّع.', priceMonthly: 138, priceYearly: 115, priceCustom: null, cta: 'ابدأ الآن', popular: true, features: ['حتى ٣٬٠٠٠ محادثة شهريًا', 'حتى ٥ وكلاء', 'خط AI كامل: ذاكرة RAG + توجيه وتصنيف', 'ملخص المحادثة عند التسليم', 'تصعيد تلقائي (عاجل / VIP / غاضب)', 'رد آلي بره ساعات العمل + حل الأسئلة الشائعة', 'دعم عبر الإيميل + شات مباشر'] },
      { id: 'business', icon: 'trending-up', name: 'Business', tagline: 'كل حاجة في Growth، مظبوطة للفرق الأكبر.', priceMonthly: 340, priceYearly: 282, priceCustom: null, cta: 'ابدأ الآن', popular: false, features: ['حتى ٨٬٠٠٠ محادثة شهريًا', 'حتى ١٥ وكيل', 'كل حاجة في Growth', 'تقييم الوكلاء واختيار ذكي', 'دعم أولوية'] },
      { id: 'enterprise', icon: 'shield', name: 'Enterprise', tagline: 'توسّع مخصّص وعزل كامل ودعم متقدّم.', priceMonthly: null, priceYearly: null, priceCustom: 'حسب الطلب', cta: 'تواصل مع المبيعات', popular: false, features: ['محادثات ووكلاء بلا حدود', 'قاعدة بيانات مخصّصة لكل عميل', 'مدير حساب مخصّص', 'تكاملات مخصّصة و SLA'] },
    ],
    comparisonTitle: 'قارن كل الخطط',
    comparisonPlans: ['Starter', 'Growth', 'Business', 'Enterprise'],
    comparison: [
      { feature: 'المحادثات شهريًا', cells: ['١٬٠٠٠', '٣٬٠٠٠', '٨٬٠٠٠', 'بلا حدود'] },
      { feature: 'الوكلاء', cells: ['حتى ٢', 'حتى ٥', 'حتى ١٥', 'بلا حدود'] },
      { feature: 'اقتراحات رد بالـ AI', cells: ['yes', 'yes', 'yes', 'yes'] },
      { feature: 'توجيه + ذاكرة RAG (خط كامل)', cells: ['no', 'yes', 'yes', 'yes + تخصيص إضافي'] },
      { feature: 'ملخص المحادثة', cells: ['no', 'yes', 'yes', 'yes'] },
      { feature: 'تصعيد تلقائي (VIP / عاجل / غاضب)', cells: ['no', 'yes', 'yes', 'yes'] },
      { feature: 'تقييم الوكلاء واختيار ذكي', cells: ['no', 'no', 'yes', 'yes'] },
      { feature: 'قاعدة البيانات', cells: ['مشتركة', 'مشتركة', 'مشتركة', 'مخصّصة'] },
      { feature: 'الدعم', cells: ['إيميل', 'إيميل + شات', 'أولوية', 'مدير مخصّص'] },
    ],
