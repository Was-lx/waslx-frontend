# US-3.4 — Groups/Teams & Agent Membership
...
| ClickUp | https://app.clickup.com/t/86caddy7v |
| Status | Not started |

## 1. User Story
> **As a** Admin/Manager, **I want** to create teams/groups and assign agents, **so that** conversations can be organized and routed by function (e.g., Sales, Operations).
...
- [ ] Create teams/groups within a tenant
- [ ] Assign Agents to one or more groups

## 4. Acceptance Criteria (the test plan)
- [ ] Groups can be created; agents belong to one or more
