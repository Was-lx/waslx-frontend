...
| ClickUp | https://app.clickup.com/t/86cae06ka |
| Status | Not started |

## 1. User Story
> **As a** Agent, **I want** a handoff UI, **so that** I can pass a conversation to another team while keeping its history.
...
- [ ] Handoff action → target group/stage selector
- [ ] Confirmation showing history is preserved

## 4. Acceptance Criteria (the test plan)
- [ ] Handoff moves to the target team's first stage; history stays visible
