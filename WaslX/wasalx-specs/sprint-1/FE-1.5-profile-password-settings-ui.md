# FE-1.5 — Profile & Password Settings UI
...
| ClickUp | https://app.clickup.com/t/86cae068u |
| Status | Not started |

## 1. User Story
> **As a** any user, **I want** a profile/settings screen, **so that** I can edit my details and change my password.
...
- [ ] A user updates profile and password without admin help
