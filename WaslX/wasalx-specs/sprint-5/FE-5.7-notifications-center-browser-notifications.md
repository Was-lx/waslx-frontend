# FE-5.7 — Notifications Center & Browser Notifications
...
| ClickUp | https://app.clickup.com/t/86cae06y0 |
| Status | Not started |

## 1. User Story
> **As a** user, **I want** a notifications center and optional browser notifications, **so that** I don't miss assignments and escalations.
...
- [ ] In-app notifications panel (unread badge)
- [ ] Browser-notification opt-in + permission flow

## 4. Acceptance Criteria (the test plan)
- [ ] Assignment/escalation events appear in-app and (if enabled) as browser notifications
