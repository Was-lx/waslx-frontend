# US-5.3 — Campaign Analytics & Controls
...
| Priority | Must (High) |
| FR Traceability | FR-CMP (CMP-06,07,08) |
| ClickUp | https://app.clickup.com/t/86cadf4hv |
| Status | Not started |

## 1. User Story
> **As a** Manager/Admin, **I want** campaign analytics and run controls, **so that** I can measure performance and manage a campaign mid-flight.
...
- [ ] Show sent/delivered/read/failed counts and rates
- [ ] Pause/resume/cancel a running or scheduled campaign
- [ ] Record campaigns and outcomes in the audit log

## 4. Acceptance Criteria (the test plan)
- [ ] Analytics reflect accurate per-status counts
- [ ] A running/scheduled campaign can be paused/resumed/cancelled
