# US-5.1 — Campaign Builder (Template & Audience)
...
| ClickUp | https://app.clickup.com/t/86caddyr7 |
| Status | Not started |

## 1. User Story
> **As a** Admin/Manager, **I want** to build a campaign with an approved template and a target audience, **so that** I can broadcast to the right customers.
...
- [ ] Create a campaign (name, approved template, audience)
- [ ] Select recipients by filter or explicit list

## 4. Acceptance Criteria (the test plan)
- [ ] A campaign is created with name, approved template, audience
- [ ] Recipients selectable by filter or list
