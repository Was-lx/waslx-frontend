# FE-5.5 — Reporting & Analytics Dashboards (Charts)
...
| ClickUp | https://app.clickup.com/t/86cae06x1 |
| Status | Not started |

## 1. User Story
> **As a** Manager, **I want** analytics dashboards with charts, **so that** I can understand team performance at a glance.
...
- [ ] Charts: agent performance, response time, volume, routing
- [ ] Date-range filter; role-scoped views

## 4. Acceptance Criteria (the test plan)
- [ ] Dashboards render correct, role-appropriate data with charts
