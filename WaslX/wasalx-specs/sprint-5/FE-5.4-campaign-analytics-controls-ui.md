# FE-5.4 — Campaign Analytics & Controls UI
...
| FR Traceability | FR-CMP (CMP-06, 07) |
| ClickUp | https://app.clickup.com/t/86cae06wb |
| Status | Not started |

## 1. User Story
> **As a** Manager, **I want** campaign analytics and run controls, **so that** I can measure and manage a send.
...
- [ ] Sent/delivered/read/failed counts + charts
- [ ] Pause/resume/cancel controls

## 4. Acceptance Criteria (the test plan)
- [ ] Analytics render accurately; controls affect the running campaign
