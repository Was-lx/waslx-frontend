...
| Priority | Must (High) |
| FR Traceability | FR-CMP (CMP-02) |
| ClickUp | https://app.clickup.com/t/86cae06ub |
| Status | Not started |

## 1. User Story
> **As a** Manager, **I want** an audience selector, **so that** I can target the right recipients.
...
- [ ] Select by filter (tags/status/attributes) or explicit list
- [ ] Live recipient count

## 4. Acceptance Criteria (the test plan)
- [ ] Audience resolves to a correct, previewable recipient set
