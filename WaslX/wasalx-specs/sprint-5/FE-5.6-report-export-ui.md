...
| ClickUp | https://app.clickup.com/t/86cae06xe |
| Status | Not started |

## 1. User Story
> **As a** Manager, **I want** an export button, **so that** I can download reports.
...
- [ ] Export-to-CSV/PDF action with format choice and progress

## 4. Acceptance Criteria (the test plan)
- [ ] Export produces an accurate CSV/PDF of the current report
