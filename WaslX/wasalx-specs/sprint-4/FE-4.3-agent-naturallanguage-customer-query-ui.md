# FE-4.3 — Agent Natural-Language Customer Query UI
...
| ClickUp | https://app.clickup.com/t/86cae06qg |
| Status | Not started |

## 1. User Story
> **As a** Agent, **I want** to ask a natural-language question about a customer and see the answer, **so that** I get instant context.
...
- [ ] Ask-about-customer input + answer display from RAG retrieval

## 4. Acceptance Criteria (the test plan)
- [ ] A question returns a relevant, readable answer about that customer
