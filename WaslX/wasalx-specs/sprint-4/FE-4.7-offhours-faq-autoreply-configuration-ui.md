# FE-4.7 — Off-Hours / FAQ Auto-Reply Configuration UI
...
| ClickUp | https://app.clickup.com/t/86cae06t7 |
| Status | Not started |

## 1. User Story
> **As a** Admin, **I want** to configure off-hours acknowledgments and FAQ auto-replies, **so that** I control automated responses.
...
- [ ] Business-hours settings; off-hours message editor
- [ ] FAQ auto-reply rules + confidence threshold control

## 4. Acceptance Criteria (the test plan)
- [ ] Admin can enable/disable and edit off-hours and FAQ auto-reply behavior
