...
| Priority | Must (High) |
| FR Traceability | FR-PADM (PADM-05) |
| ClickUp | https://app.clickup.com/t/86cae071f |
| Status | Not started |

## 1. User Story
> **As a** Platform Owner, **I want** billing and invoicing screens, **so that** I can manage invoices and payments per tenant.
...
- [ ] Billing status view
- [ ] Invoice list/detail; payment records

## 4. Acceptance Criteria (the test plan)
- [ ] Invoices and payment status display accurately per tenant
