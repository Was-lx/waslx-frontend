# FE-6.2 — Tenant Management UI (Lifecycle)
...
| ClickUp | https://app.clickup.com/t/86cae0701 |
| Status | Not started |

## 1. User Story
> **As a** Platform Owner, **I want** tenant management screens, **so that** I can create, configure, suspend, reactivate, and delete tenants.
...
- [ ] Tenant list + detail
- [ ] Lifecycle actions with confirmations

## 4. Acceptance Criteria (the test plan)
- [ ] All lifecycle actions are available and reflect state changes
