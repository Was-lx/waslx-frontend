# FE-6.8 — Impersonation Controls UI
...
| ClickUp | https://app.clickup.com/t/86cae07m7 |
| Status | Not started |

## 1. User Story
> **As a** Platform Owner, **I want** impersonation controls, **so that** I can support a tenant within a scoped, time-limited session.
...
- [ ] Start/stop impersonation; persistent banner; session timer; clear exit

## 4. Acceptance Criteria (the test plan)
- [ ] Impersonation is visibly indicated, time-limited, and logged
