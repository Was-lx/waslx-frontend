# FE-6.5 — Global Usage Dashboards UI
...
| ClickUp | https://app.clickup.com/t/86cae071t |
| Status | Not started |

## 1. User Story
> **As a** Platform Owner, **I want** global usage dashboards, **so that** I can monitor platform adoption.
...
- [ ] Cross-tenant charts: active tenants, conversations, messages, active agents

## 4. Acceptance Criteria (the test plan)
- [ ] Dashboards render accurate aggregated metrics
