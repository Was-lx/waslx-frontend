# US-6.4 — Global Usage Dashboards
...
| Priority | Must (High) |
| FR Traceability | FR-PADM (PADM-06) |
| ClickUp | https://app.clickup.com/t/86cadf4xt |
| Status | Not started |

## 1. User Story
> **As a** Platform Owner, **I want** global usage dashboards across the platform, **so that** I can monitor adoption and activity at a glance.
...
- [ ] Global dashboards (active tenants, conversations, messages, active agents)

## 4. Acceptance Criteria (the test plan)
- [ ] Dashboards show accurate cross-tenant usage metrics
