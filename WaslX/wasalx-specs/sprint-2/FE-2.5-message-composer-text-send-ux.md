# FE-2.5 — Message Composer — Text & Send UX
...
| Priority | Must (High) |
| FR Traceability | FR-WA (WA-03) |
| ClickUp | https://app.clickup.com/t/86cae06e0 |
| Status | Not started |

## 1. User Story
> **As a** Agent, **I want** a message composer, **so that** I can type and send replies smoothly.
...
- [ ] Optimistic send; pending/failed/retry states

## 4. Acceptance Criteria (the test plan)
- [ ] Sent messages appear instantly and reconcile with delivery status
