# FE-2.6 — Message Composer — Media Upload
...
| ClickUp | https://app.clickup.com/t/86cae06ed |
| Status | Not started |

## 1. User Story
> **As a** Agent, **I want** to attach and send media, **so that** I can share images and files with customers.
...
- [ ] File picker, preview, upload progress, type/size validation

## 4. Acceptance Criteria (the test plan)
- [ ] Supported media uploads with progress and sends successfully
